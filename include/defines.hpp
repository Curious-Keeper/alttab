...
inline int SPACING_WINDOW;
inline int SPACING_MONITOR;
inline float MONITOR_SIZE;
inline float MONITOR_SIZE_ACTIVE = 0.4f;
inline float MONITOR_SIZE_INACTIVE = 0.3f;
