...
inline int WINDOW_SPACING;
inline float WINDOW_SIZE_INACTIVE;
inline int MONITOR_SPACING;
inline float MONITOR_SIZE_ACTIVE;
inline float MONITOR_SIZE_INACTIVE;
